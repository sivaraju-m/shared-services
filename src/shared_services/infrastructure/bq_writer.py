...
class BigQueryWriter:
    ...
    def __init__(self, project_id: str, dataset_id: str, table_id: str, 
        ...
        logger.info(f"BigQuery Writer initialized: {project_id}.{dataset_id}.{table_id}")
    ...
    def _ensure_table_exists(self) -> None:
        ...
        try:
            ...
            table.description = "AI Trading Machine backtest results with comprehensive metrics"
            ...
            logger.info(f"Created table {self.table_id} with partitioning and clustering")
    ...
    def insert_result(self, result_dict: Dict[str, Any], run_id: Optional[str] = None) -> bool:
        """
    ...
    def insert_batch_results(self, results: List[Dict[str, Any]], 
